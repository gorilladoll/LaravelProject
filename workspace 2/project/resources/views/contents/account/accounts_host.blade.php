			        ...
			        "categories": [{
			            "category": [
				            @for($i = 0, $length = count($accountInfo['pagingThInfo']); $i < $length; $i++)
				        		{
				        			"label":"{{$accountInfo['pagingThInfo'][$i]->flea_name}}<br>"+{{$accountInfo['pagingThInfo'][$i]->th}}+"차"
				        		},
				        	@endfor
			        	]
			        }],
					    ...
					    dataSource: {
					        ...
					        "categories": [{
					            "category": [
						            @for($i = 0, $length = count($accountInfo['pagingThInfo']); $i < $length; $i++)
						        		{
						        			"label":"영진 플리마켓<br>"+{{$accountInfo['pagingThInfo'][$i]->th}}+"차"
						        		},
						        	@endfor
					        	]
					        }],
					        ...
					        "categories": [{
					            "category": [
						            @for($i = 0, $length = count($accountInfo['monthInfo']); $i < $length; $i++)
						        		{
						        			"label":"{{$accountInfo['monthInfo'][$i]->month}}"+"월"
						        		},
						        	@endfor
					        	]
					        }],
					        ...
					        "categories": [{
					            "category": [
						            @for($i = 0, $length = count($accountInfo['yearInfo']); $i < $length; $i++)
						        		{
						        			"label":"20"+{{$accountInfo['yearInfo'][$i]->year}}+"년"
						        		},
						        	@endfor
					        	]
					        }],
