  ...
  <body style="background-color:#f2f2f2;">
    <div class="body" >
      ...
      <div class="header" style="">
        ...
        <div class="menu_bar text-center" style="float:left; margin-top:50px; width:35%; font-weight:bold;">
          <!-- 로그인, 회원가입 -->
        ...
        <div class="menu_bar" style="margin-left:4%; float:left; margin-top:50px; width:20%; font-weight:bold;">
          <!-- 로그인, 회원가입 -->
          <!-- 플리마켓, 벼룩공방, 마일리지 샵, 마이페이지  -->
          <div class="menu">
