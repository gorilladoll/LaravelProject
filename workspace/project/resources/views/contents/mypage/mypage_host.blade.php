...
<script>
  $(document).ready(function(){
      var group_list = "<div class='mypage_result_list'><div class='list_image'></div><div style='width:20%;' class='list_name'>영진 플리마켓</div>" +
          "<div class='list_name' style='width:20%;'>최근 개최 회차:1회</div><div style='width:30%;' class='list_name'>최근 개최 일자 : 2017-06-13</div><div class='list_button'>" +
  ...
  <div class="mypage_user">
    ...
    <div class="jumbotron">
      <div class="info">
        ...
        <div class="info_message">최근 개최 플리마켓 : 영진 플리마켓 1회차</div>
