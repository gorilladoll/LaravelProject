...
// 마일리지 샵
Route::get('mileage/mileageshop', function(){
    return view('contents.mileage.mileage_host_ad');
});

Route::get('mileage/mileageshop_sell', function(){
    return view('contents.mileage.mileage_sell_ad');
});

Route::get('mileage/mileageshop_discount', function(){
    return view('contents.mileage.mileage_discount');
});
...
// 판매자 마이페이지
Route::get('mypage/seller', function(){
    return view('contents.mypage.mypage_seller');
});

// 구매자 마이페이지
Route::get('mypage/buyer', function(){
    return view('contents.mypage.mypage_buyer');
});

Route::get('mypage/calendar',function(){
    return view('contents.mypage.mypage_calendar');
});
...
Route::get('/mylab/createJson','MylabController@createJson');
